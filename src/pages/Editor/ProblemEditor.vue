    ...
    <el-card class="box-card">
        ...
        <el-row>
            <el-col :span="24">
                ...
                <h5>上传测试点</h5>
                <el-upload accept=".zip" :on-change="UploadOnChange" :auto-upload="false" :show-file-list="false">
                    <el-input :placeholder="file_name" slot="trigger" readonly />
                </el-upload>
...
function UploadOnChange(file, _) {
    file_name.value = file.name
    const formData = new FormData();
    formData.append('file', file.raw);
    formData.append('pid',problemid.value)
    service.post('/api/problem/upload', formData, {
        headers: {
